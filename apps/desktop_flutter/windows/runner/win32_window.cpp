...
Win32Window::MessageHandler(HWND hwnd,
  ...
  switch (message) {
    ...
    case WM_NCHITTEST: {
      ...
      constexpr LONG resize_border = 8;
    ...
    case WM_GETMINMAXINFO: {
      ...
      minmax_info->ptMinTrackSize.x = 360;
      minmax_info->ptMinTrackSize.y = 560;
      return 0;
    }
...
void Win32Window::UpdateTheme(HWND const window) {
  ...
  const bool use_light_frame = result == ERROR_SUCCESS && light_mode != 0;
  const COLORREF border_color =
      use_light_frame ? RGB(221, 226, 218) : RGB(53, 58, 53);
  const COLORREF caption_color =
      use_light_frame ? RGB(246, 247, 245) : RGB(24, 27, 25);
